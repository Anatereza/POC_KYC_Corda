...
public  class CertiScheduleState implements ContractState, QueryableState, SchedulableState {
    ...
    Instant dateexp = Instant.now().plusSeconds(15);

    //private Instant dateexp = Instant.now().plusSeconds(15);
    /**
    ...
    public  CertiScheduleState(String Cert, String Client, String docKYC, Integer Status, Integer Maintien, Party Initiator, String Profil, List<String> Documents, String Description, String DateCreation, String DateProchaineCert, Party other1,
                            Party other2) {
    ...
    @Override public Iterable<MappedSchema> supportedSchemas() {
        return ImmutableList.of(new CertiScheduleSchemaV1());
    }
    ...
    @Override public PersistentState generateMappedObject(MappedSchema schema) {
        if (schema instanceof CertiScheduleSchemaV1) {
            return new CertiScheduleSchemaV1.PersistentCertiSchedule(
                    this.Cert,
                    this.Client,
                    this.DocKYC,
                    this.Status,
    ...
    public ScheduledActivity nextScheduledActivity(@NotNull StateRef thisStateRef, @NotNull FlowLogicRefFactory flowLogicRefFactory) {
        ...
        //flowLogicRefFactory = (FlowLogicRefFactory) flowLogicRefFactory.create("com.template.ScheduleTestFlow", thisStateRef);
        return new ScheduledActivity((flowLogicRefFactory.create("com.template.ScheduleTestFlow", thisStateRef)), dateexp);
    }
