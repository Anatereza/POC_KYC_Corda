...
@InitiatingFlow
@StartableByRPC
public class DocKYCFlow extends FlowLogic<SignedTransaction> {
    ...
    public DocKYCFlow(String docKYC, SecureHash docHash) {
        this.DocKYC = docKYC;
    ...
    public SignedTransaction call() throws FlowException {
        ...
        //DocKYCState(String DocKYC, String Date, Party Entite, Party other1,
        //                         Party other2)
        DocKYCState outputState = new DocKYCState(DocKYC, now, getOurIdentity(), other2, other3);
