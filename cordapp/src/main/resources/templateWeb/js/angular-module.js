...
// script ajouté
    demoApp.getRequest = () => $http.get(apiBaseURL + "Request")
        .then((response) => demoApp.Request = Object.keys(response.data)
...
app.controller('ModalInstanceCtrl', function ($http, $location, $uibModalInstance, $uibModal, demoApp, apiBaseURL) {
   ...
   // modalInstance.peers = peers;
    ...
    //    } else {
            ...
            const createIOUEndpoint = `${apiBaseURL}sendRequest?doc=${modalInstance.form.doc}&client=${modalInstance.form.client}`;
                   //     const createIOUEndpoint = `${apiBaseURL}sendRequest?doc=${modalInstance.form.doc}&client=${modalInstance.form.client}&other1=O=Na,L=Paris,C=FR&other2=O=CE,L=Paris,C=FR`;
    ...
    function invalidFormInput() {
        ...
        return isNaN(modalInstance.form.doc) || (modalInstance.form.client === undefined);
    }
});
